...
| Vercel | Recorrente | Hobby | US$ 0.00 | Ativo | Pode continuar gratis no MVP se ficar dentro dos limites. |
...
**Total fixo mensal atual:** US$ 29.00
...
| Vercel | Build/runtime acima do free ou upgrade Pro | Manter Hobby enquanto for teste. |
