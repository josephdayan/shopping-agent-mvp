...
import OperatorTestBoard from "./OperatorTestBoard";

export const dynamic = "force-dynamic";
export const metadata = { title: "Teste do operador" };
...
export default function OperatorTestPage({ searchParams }: { searchParams: { key?: string } }) {
  if (!tokenMatches(searchParams.key, process.env.OPS_TEST_TOKEN)) {
    return (
      <main style={{ maxWidth: 620, margin: "0 auto", padding: "64px 24px", fontFamily: "system-ui, sans-serif" }}>
        <h1 style={{ margin: 0, fontSize: 24 }}>Acesso ao teste</h1>
